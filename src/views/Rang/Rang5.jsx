          ...
          <tbody>
            {topHeroes.map((hero) => (
              <tr key={hero.id} className="hero-row">
                ...
                <td className="hero-stats">{hero["5_pick"]}</td>
                <td className="hero-stats">{hero["5_win"]}</td>
                <td className="hero-stats">
                  {((hero["5_win"] / hero["5_pick"]) * 100).toFixed(2)}%
                </td>
              </tr>
            ))}
          </tbody>
